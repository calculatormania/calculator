class Question {
	public static void main(String[] args){
		int n = 0;
		System.out.println("クイズを行います。番号を選択して回答してください。");
		System.out.println();

		//一問目
		System.out.println("問1:スーパーマリオRPGにおいてブッキータワーで入手できるマリオの武器は？");
		System.out.println("1.ひまんパタこうら " + "2.おうじゃのつるぎ " + "3.ムラっけハンマー " + "4.エクスカリバー");
		int ans1 = new java.util.Scanner(System.in).nextInt();
		if(ans1 == 3) {
			System.out.println("正解！");
			n += 1; 
		}
		else if (ans1 == 2 || ans1 == 4) {
			System.out.println("それは別のゲームに出てくる武器です...");
			n += 0;
		}
		else {
		...
		System.out.println("1.FF4 " + "2.GoGoアックマン " + "3.F-ZERO " + "4.MOTHER2 " + "5.パイロットウィングス");
